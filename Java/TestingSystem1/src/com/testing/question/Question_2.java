...
public class Question_2 {
    public static void main(String[]args){
        ...
        System.out.println((acc2.DepartmentID==null)?("Nhân viên này chưa có phòng ban"):("Phòng ban của nhân viên này là : "+acc2.DepartmentID.DepartmentName));
