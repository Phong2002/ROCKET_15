...
public class EX3_DateFormat {
    public static void main(String [] args ){
        ...
        System.out.println("CreatorID : "+exam1.CategoryID);
        Locale localevn = new Locale("vi","VI");
        SimpleDateFormat simpleDateFormat = new SimpleDateFormat("dd MMMM yyyy",localevn);
        System.out.println((simpleDateFormat.format(exam1.CreateDate)));

        // Question 2:
        System.out.println("Question 2:");
        Exam [] exams = {exam1,exam2,exam3,exam4,exam5};
        SimpleDateFormat simpleDateFormatQ2 = new SimpleDateFormat("yyyy-MM-dd HH-mm-ss");
        for(Exam ex:exams){
            System.out.println("Exam  "+ex.ExamID+" CreateDate : "+simpleDateFormatQ2.format(ex.CreateDate));
        }

        // Question 3:
        System.out.println("Question 3: ");
        SimpleDateFormat simpleDateFormatQ3 = new SimpleDateFormat("yyyy");
        for(Exam ex:exams){
            System.out.println("Exam  "+ex.ExamID+" CreateDate : "+simpleDateFormatQ3.format(ex.CreateDate));
        }

        // Question 4:
        System.out.println("Question 4: ");
        SimpleDateFormat simpleDateFormatQ4 = new SimpleDateFormat("MM/yyyy");
        for(Exam ex:exams){
            System.out.println("Exam  "+ex.ExamID+" CreateDate : "+simpleDateFormatQ4.format(ex.CreateDate));
        }
