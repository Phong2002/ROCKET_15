...
public class EX2_SystemOutPrintf {
    public static void main (String [] args){
        ...
        float q3 = (float) 5.567098;
        System.out.printf("%.4f%n",q3);

        // Question 4:
        Scanner sc= new Scanner(System.in);
        String q4 = sc.nextLine();
        System.out.println("Tôi tên là : "+q4+" và tôi đã có người iu >>");
        ...
        System.out.printf("%-30s %-30s %-30s","Email","FullName","Department");
        System.out.println("");
        for (Account acc : accounts) {
            System.out.printf("%-30s %-30s %-30s", acc.Email, acc.FullName, acc.DepartmentID.DepartmentName);
            System.out.println("");
        }
